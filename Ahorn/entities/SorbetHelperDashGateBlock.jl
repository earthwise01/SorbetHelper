...
@pardef DashGateBlock(x1::Integer, y1::Integer, x2::Integer=x1+16, y2::Integer=y1, width::Integer=Maple.defaultBlockWidth, height::Integer=Maple.defaultBlockHeight,
    ...
    shakeTime::Number=0.5, moveTime::Number=1.8, moveEased::Bool=true, allowWavedash::Bool=false, moveSound::String="event:/game/general/touchswitch_gate_open", finishedSound::String="event:/game/general/touchswitch_gate_finish", smoke::Bool=true, persistent::Bool=false) =
    ...
    inactiveColor=inactiveColor, activeColor=activeColor, finishColor=finishColor, shakeTime=shakeTime, moveTime=moveTime, moveEased=moveEased, allowWavedash=allowWavedash, moveSound=moveSound, finishedSound=finishedSound, smoke=smoke, persistent=persistent)
...
Ahorn.editingOrder(entity::DashGateBlock) = String["x", "y", "width", "height", "inactiveColor", "activeColor", "finishColor", "moveSound", "finishedSound", "shakeTime", "moveTime", "moveEased", "blockSprite", "iconSprite", "allowWavedash", "smoke", "persistent"]
