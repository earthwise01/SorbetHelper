...
public class SorbetHelperCommands {
    private const string sorbetHelperPrefix = "sh";

    // camera offset
    [Command($"{sorbetHelperPrefix}_set_camera_offset_x", "Sets the camera X offset to the specifed value. [Sorbet Helper]")]
    ...
    [Command($"{sorbetHelperPrefix}_set_camera_offset_y", "Sets the camera X offset to the specifed value. [Sorbet Helper]")]
    ...
    [Command($"{sorbetHelperPrefix}_get_camera_offset", "Shows the current camera X/Y offsets. [Sorbet Helper]")]
