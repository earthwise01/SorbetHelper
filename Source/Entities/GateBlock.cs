...
namespace Celeste.Mod.SorbetHelper.Entities {
    ...
    // legacy entity, planning to eventually rewrite a lot hopefully maybe it depends idk
    [Tracked(true)]
    public class GateBlock : Solid {

        // A bunch of code here is copy-pasted from MaddieHelpingHand's Flag Switch Gates as I didn't want to have to bother with cleaning up the vanilla code
